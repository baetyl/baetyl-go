...
func init() {
	proto.RegisterType((*KV)(nil), "kv.KV")
	proto.RegisterType((*KVs)(nil), "kv.KVs")
}
...
var fileDescriptor_2216fe83c9c12408 = []byte{
	...
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xca, 0x2e, 0x93, 0x92, 0x4e, 0xcf, 0xcf, 0x4f, 0xcf, 0x49,
	0xd5, 0x07, 0x8b, 0x24, 0x95, 0xa6, 0xe9, 0xa7, 0xe6, 0x16, 0x94, 0x54, 0x42, 0x14, 0x48, 0xe9,
	0xa6, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xa7, 0xe7, 0xa7, 0xe7, 0x23,
	0x54, 0x81, 0x78, 0x60, 0x0e, 0x98, 0x05, 0x51, 0xae, 0xa4, 0xc3, 0xc5, 0xe4, 0x1d, 0x26, 0x24,
	...
	0x4a, 0xf2, 0x5c, 0xcc, 0xde, 0x61, 0xc5, 0x42, 0x12, 0x5c, 0xcc, 0xd9, 0x65, 0xc5, 0x12, 0x8c,
	0x0a, 0xcc, 0x1a, 0xdc, 0x46, 0x6c, 0x7a, 0xd9, 0x65, 0x7a, 0xde, 0x61, 0x41, 0x20, 0x21, 0xa3,
	0x89, 0x8c, 0x5c, 0x9c, 0xde, 0x61, 0xc1, 0xa9, 0x45, 0x65, 0x99, 0xc9, 0xa9, 0x42, 0xea, 0x5c,
	0xcc, 0xc1, 0xa9, 0x25, 0x42, 0x50, 0x15, 0x52, 0x62, 0x7a, 0x10, 0x87, 0xeb, 0xc1, 0x9c, 0xa4,
	0xe7, 0x0a, 0x72, 0xb8, 0x12, 0x83, 0x90, 0x38, 0x17, 0xb3, 0x3b, 0x92, 0x42, 0x28, 0xad, 0xc4,
	0x00, 0x32, 0xc1, 0x25, 0x35, 0x87, 0x08, 0x13, 0x24, 0xb9, 0x58, 0x7c, 0x32, 0x8b, 0x11, 0x46,
	0xb0, 0x43, 0xe8, 0x62, 0x25, 0x06, 0x27, 0x9d, 0x13, 0x0f, 0xe5, 0x18, 0x7e, 0x3c, 0x94, 0x63,
	...
	0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x89, 0x0d, 0x6c, 0xb4, 0x31, 0x20, 0x00, 0x00, 0xff,
	0xff, 0x9e, 0x6d, 0xb5, 0x9d, 0x73, 0x01, 0x00, 0x00,
}
...
func (c *kVServiceClient) Del(ctx context.Context, in *KV, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/kv.KVService/Del", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kVServiceClient) List(ctx context.Context, in *KV, opts ...grpc.CallOption) (*KVs, error) {
	out := new(KVs)
	err := c.cc.Invoke(ctx, "/kv.KVService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func NewPopulatedKV(r randyKv, easy bool) *KV {
	this := &KV{}
	this.Key = string(randStringKv(r))
	v1 := r.Intn(100)
...
func randFieldKv(dAtA []byte, r randyKv, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateKv(dAtA, uint64(v4))
	case 1:
		dAtA = encodeVarintPopulateKv(dAtA, uint64(key))
